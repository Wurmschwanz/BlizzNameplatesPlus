...
local CAST_FEEDBACK_DURATION = 0.30
  ...
  elseif eventType == "FAIL" then
    ...
    if previous and previous.duration and previous.duration > 0 then
      ...
      castFeedback[guid] = {
        ...
        endTime = now + CAST_FEEDBACK_DURATION,
        flashDuration = CAST_FEEDBACK_DURATION,
      }
    end
    casts[guid] = nil
  end
      ...
      if not cast and not feedback then
        ...
        if bar then
          ...
          if cast then
            ...
            local flashDuration = feedback.flashDuration or CAST_FEEDBACK_DURATION
