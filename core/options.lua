...
function BNP:CreateOptions()
  ...
  healthTextLabel:SetPoint("TOPLEFT", nameplatesPage, "TOPLEFT", 28, -248)
  ...
  healthTextDropdown:SetPoint("TOPLEFT", nameplatesPage, "TOPLEFT", 10, -260)
  ...
  if comboOptionsClass then
    local comboPoints = CreateCheck(nameplatesPage, "Combo Points", -208, function()
  ...
  UIDropDownMenu_SetWidth(92, debuffPositionDropdown)
  ...
  debuffPositionLabel:SetText("Position")
  frame.debuffPositionLabel = debuffPositionLabel

  local crowdControl = CreateCheck(aurasPage, "Crowd Control", -174, function()
  ...
  local separateCCRow = CreateCheck(aurasPage, "Display CCs in Separate Row", -206, function()
  ...
  local showOtherCCs = CreateCheck(aurasPage, "Show CCs from Other Players", -238, function()
  ...
  function frame:UpdateDependentControls()
    ...
    local position = BNP.GetDebuffPosition and BNP:GetDebuffPosition() or "top"
    local separateRowAvailable = ccEnabled and position == "top"
...
function BNP:SyncOptions()
  ...
  if frame.debuffPositionDropdown then
    ...
    UIDropDownMenu_SetText(labels[position] or "Top", frame.debuffPositionDropdown)
  end
