...
function BNP:CreateOptions()
  ...
  CreateSection(nameplatesPage, "Names", -138)

  local hidePlayerNames = CreateCheck(nameplatesPage, "Hide Player Names", -166, function()
  ...
  local hideNPCNames = CreateCheck(nameplatesPage, "Hide NPC/Mob Names", -166, function()
  ...
  local nameFontSize = CreateSlider(nameplatesPage, "Name Font Size", 8, 24, 1, -210, 28, 150)
  ...
  local nameFontYOffset = CreateSlider(nameplatesPage, "Name Y Offset", -50, 50, 1, -210, 220, 150)
  ...
  castbarTest:SetScript("OnEnter", function()
    ...
    GameTooltip:AddLine("Use it to adjust height, spacing, font size and offsets live. The test mode is not saved.", 0.8, 0.8, 0.8, true)
    GameTooltip:Show()
  end)
  ...
  local castbarFontSize = CreateSlider(castbarPage, "Castbar Font Size", 6, 18, 1, -202)
  ...
  local castbarXOffset = CreateSlider(castbarPage, "Castbar X Offset", -50, 50, 1, -256, 28, 150)
  ...
  local castbarYOffset = CreateSlider(castbarPage, "Castbar Y Offset", -50, 50, 1, -256, 220, 150)
