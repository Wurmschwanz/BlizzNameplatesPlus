...
function BNP:CreateOptions()
  ...
  healthTextLabel:SetPoint("TOPLEFT", nameplatesPage, "TOPLEFT", 218, -242)
  ...
  healthTextDropdown:SetPoint("TOPLEFT", nameplatesPage, "TOPLEFT", 200, -254)
  ...
  if comboOptionsClass then
    ...
    local comboYOffset = CreateSlider(nameplatesPage, "Combo Point Y Offset", -50, 50, 1, -274, 28, 150)
  ...
  local icon = CreateSlider(aurasPage, "Aura Icon Size", 12, 32, 1, -38, 28, 150)
  ...
  local debuffYOffset = CreateSlider(aurasPage, "Debuff Y Offset", -50, 50, 1, -38, 220, 150)
  ...
  local ccIcon = CreateSlider(aurasPage, "CC Icon Size", 12, 32, 1, -86, 28, 150)
  ...
  local ccYOffset = CreateSlider(aurasPage, "CC Y Offset", -50, 50, 1, -86, 220, 150)
  ...
  local immunityIcon = CreateSlider(aurasPage, "Immunity Icon Size", 12, 32, 1, -350, 28, 150)
  ...
  local immunityYOffset = CreateSlider(aurasPage, "Immunity Y Offset", -50, 50, 1, -350, 220, 150)
