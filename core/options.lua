...
function BNP:CreateOptions()
  ...
  local showOtherCCs = CreateCheck(aurasPage, "Show CCs from Other Players", -262, function()
  ...
  function frame:UpdateDependentControls()
    ...
    local separateRowAvailable = ccEnabled and debuffPosition == "top" and ccPosition == "top"
